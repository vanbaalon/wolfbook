...
(function () {
    ...
    function renderMcpInfo(info) {
        ...
        var html = [
            ...
            disabled ? '' : '<a href="#" data-cmd="wolfbook.openActivityMonitor" style="display:block; margin:6px 0 10px; padding:7px 9px; border:1px solid var(--vscode-button-border,transparent); border-radius:4px; color:var(--vscode-button-foreground,#fff); background:var(--vscode-button-background,#0e639c); text-align:center; text-decoration:none; font-weight:600;">Open MCP Control Room</a>',
